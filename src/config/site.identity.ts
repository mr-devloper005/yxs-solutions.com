export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'yxs-solutions',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Yxs Solutions',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'yxs-solutions.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://yxs-solutions.com',
